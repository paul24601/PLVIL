...
<body>
    <div class="card-body">
        <div class="row">
            <div class="col-12 col-md-3 add-book">
                <button class="btn btn-success btn-md" data-toggle="modal" data-target="#addBook">
                ...
                <table class="table table-bordered display" id="datatablesSimple">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="/PLVIL/Admin/uploads/<?php echo $book['image1']; ?>" alt="Book Stem" style="width: 100px; height: 100px;"></td>
                            <td><img src="/PLVIL/Admin/uploads/<?php echo $book['image2']; ?>" alt="Front Cover" style="width: 100px; height: 100px;"></td>
                ...
                <div class="modal-body">
                    <form id="addBookForm" method="POST" enctype="multipart/form-data">
                        <div class="input-group mb-3">
                            <label style=" width: 160px;" class="input-group-text" for="inputGroupSelect01">Book
                                Category</label>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="file" class="form-control" id="inputGroupFile01" name="image1" accept="image/*"
                                required>
                        </div>
                        <div class="input-group mb-3">
                            <label class="input-group-text" for="inputGroupFile02">Image Front Cover</label>
                            <input type="file" class="form-control" id="inputGroupFile02" name="image2" accept="image/*"
                                required>
                        </div>
                    </form>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editBookForm">
                        <input type="hidden" id="editBookId">
                        <div class="input-group mb-3">
                            <label style=" width: 160px;" class="input-group-text" for="bookCategoryEdit">Book
                                Category</label>
                        ...
                        <div class="input-group mb-3">
                            <span style=" width: 160px;" class="input-group-text" for="columnNumberEdit">Shelves
                                Number</span>
                        ...
                        <div class="input-group mb-3">
                            <span style=" width: 160px;" class="input-group-text" for="bookEditionEdit">Book
                                Edition</span>
                        ...
                        <div class="input-group mb-3">
                            <span style=" width: 160px;" class="input-group-text" for="callNumberEdit">Call
                                Number</span>
                        ...
                        <div class="input-group mb-3">
                            <label class="input-group-text" for="inputGroupFile01">Image Book Stem</label>
                            <input type="file" class="form-control" id="inputGroupFile03" name="image1"
                                accept="image/*">
                        </div>
                        <div class="input-group mb-3">
                            <label class="input-group-text" for="inputGroupFile02">Image Front Cover</label>
                            <input type="file" class="form-control" id="inputGroupFile04" name="image2"
                                accept="image/*">
                        </div>
                    </form>
                </div>
