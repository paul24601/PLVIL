                                    ...
                                    <tbody class="table-group-divider">
                                        ...
                                        foreach ($books as $book):
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="/PLVIL/revised/Admin/uploads/<?php echo $book['image1']; ?>"
                                                        alt="Book Stem" style="width: 100px; height: 100px;"></td>
                                                <td><img src="/PLVIL/revised/Admin/uploads/<?php echo $book['image2']; ?>"
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#addBookBtn').on('click', function () {
                ...
                $.ajax({
                    url: '/PLVIL/revised/Admin/classes/Book.php',
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            $('.editButton').on('click', function () {
                ...
                $.post('/PLVIL/revised/Admin/classes/Book.php', { getBookById: bookId }, function (data) {
