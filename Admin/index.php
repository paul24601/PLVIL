    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="addBookForm" method="POST" enctype="multipart/form-data">
            ...
            <div class="input-group mb-3">
                <span style= " width: 160px;" class="input-group-text">column Number</span>
                <input type="text"name="columnNumber" class="form-control" required placeholder="Enter Column Number" required>
            </div>
            <div class="input-group mb-3">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="editBookForm">
          ...
          <div class="input-group mb-3">
            <span style= " width: 160px;" class="input-group-text" for="columnNumberEdit">Column Number</span>
